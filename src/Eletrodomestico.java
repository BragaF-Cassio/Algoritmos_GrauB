...
public class Eletrodomestico extends Produto{
	...
	public Eletrodomestico(String nome, String descricao, String marca, String cor, String categoria, double valor, int quantidade, int anoDeLancamento, String eficienciaEnergetica) {
